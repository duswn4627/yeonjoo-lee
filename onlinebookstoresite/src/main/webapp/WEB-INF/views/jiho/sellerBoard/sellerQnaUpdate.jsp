...
<div id="obQnaDetail">
	<h1><img src="${cp }/resources/jh/jhimages/문의사항 수정_1.png" style="margin-left: 125px;"></h1>
	<div id="sellerMoon">
			...
			<form action="${cp }/seller/goqnaupdate" method="post">
				<div id="sellerdap">
					...
					<img id="dapimg" src="${cp}/resources/jh/jhimages/문의답글이미지.jpg" >
						<textarea rows="5" cols="90" id="dapTextarea" name="obqacontent">${answerList.obqacontent}</textarea>
				</div>
				<button type="submit" class="btn btn-primary" id="dapupdatebt">수정하기</button>
